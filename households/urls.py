...
urlpatterns = [
    ...
    path('barangay/members/<int:member_id>/mark-deceased/', views.mark_member_deceased, name='mark_member_deceased'),
    path('barangay/members/<int:member_id>/unmark-deceased/', views.unmark_member_deceased, name='unmark_member_deceased'),
